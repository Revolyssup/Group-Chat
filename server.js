...
/*function is executed when a socket connection is established and that socket is passed as argument*/
function cbOnconnect(socket){
 
    
    console.log(`new user`);

    /* listens for chat-msg event and emits it back to other clients with name and message of client sending the message */
    ...
    /*listens for name event (when a client enters the name) and emits it back to other clients with name of client sending the message */
    socket.on(`name`, (name)=>{
